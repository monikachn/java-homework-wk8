 ...
 * it(sumFLastDigirstAnd252); →should return 4, the first digit is 2 and the last is 2 which gives us 2+2 and the sum is 4.
...
public class P7_FirstAndLastDigitSum {
    public static void main(String[] args) {
        ...
        System.out.println("sumFirstAndLastDigit(0) "  + sumFirstAndLastDigit(5)  ) ;
        System.out.println("sumFirstAndLastDigit(0) "  + sumFirstAndLastDigit(-10)  ) ;
